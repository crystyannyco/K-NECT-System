                                    ...
                                    <?php if (!empty($user_list)): ?>
                                        <?php foreach ($user_list as $user): ?>
                                            <tr class="hover:bg-gray-50"
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    <?php
                                                        $position = isset($user['position']) ? (int)$user['position'] : 1;
                                                        echo $position == 1 ? 'KK Member' : ($position == 2 ? 'SK Kagawad' : ($position == 3 ? 'Secretary' : ($position == 4 ? 'Treasurer' : 'KK Member')));
                                                    ?>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <a href="#" 
    ...
    <div id="bulkChangeModal" class="fixed inset-0 z-[99999] hidden bg-black bg-opacity-40 flex items-center justify-center p-4">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-8 relative">
            ...
            <p class="text-sm text-gray-600 mb-4 text-center">Change the position for selected users.</p>
            <div class="mb-6">
            ...
            <div class="flex overflow-hidden">
                ...
                <div class="w-1/3 bg-gray-50 p-6 flex flex-col items-center justify-start">
                    ...
                    <div class="w-full bg-white rounded-md p-3 shadow-sm border">
                        <label for="modalUserType" class="block text-sm font-medium text-gray-700 mb-2">Position</label>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#modalUserType').val(String(u.position || 1));
                                ...
                                // Enable position change for all users
